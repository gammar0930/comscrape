...
const PolkadotWallet = () => {
    ...
    return (
        <>
            ...
            <div className=" flex items-center justify-start h-[23svh] flex-col">

                <span className="text-center mb-5" style={{ fontSize: '20px' }}>Connect to Comscrape</span>
...

                {
                    accounts.length > 0 && !selectedAccount ? (
                        <div className="shadow-md p-4 bg-neutral-100">
