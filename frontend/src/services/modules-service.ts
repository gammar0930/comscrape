...
export const modelList = [
  {
    data: [
      ...
      { type: 'image', url: 'https://example.com/image1.jpg', name: 'Image 1', attributes: { width: 800, height: 600 } },
  ...
  {
    data: [
      { owner: 'Bob', date: '22/02/2024' },
      { type: 'text', content: 'Another text sample.' },
      { type: 'image', url: 'https://example.com/image2.jpg', name: 'Image 2', attributes: { width: 1200, height: 900 } },
      { type: 'video', url: 'https://example.com/video2.mp4', name: 'Video 2', attributes: { duration: '4:30', resolution: '1280x720' } },
      { type: 'audio', url: 'https://example.com/audio2.mp3', name: 'Audio 2', attributes: { duration: '3:00', bitrate: '192 kbps' } },
    ],
  },
  {
    data: [
